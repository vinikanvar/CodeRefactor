...
public class AddonGroupMapper implements ResultSetMapper<AddonGroup> {
    ...
    public AddonGroup map(int index, ResultSet result, StatementContext context) throws SQLException {
        ...
        try {
            ...
            try {
                List<Map<String, Object>> value = mapper.readValue(result.getString("value"), new TypeReference<List<Map<String, Object>>>() {
                });
                addonGroup.setValue(value);
        ...
        try {
            Map<String, Map<String, Object>> model = mapper.readValue(result.getString("model"), new TypeReference<Map<String, Object>>() {
            });
