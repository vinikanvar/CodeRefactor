...
/**
 * @version $Id: cd352aa4be1409b8f916885001367277cb17b2a7 $
 */
public class ResultSetRepresentationTest {
    ...
    public void testCreateResultSetRepresentation() throws Exception {
        ...
        ResultSetRepresentation<Object> resultSet = new ResultSetRepresentation<Object>("/test/", 10, 20, Arrays.asList(objects), 42);
