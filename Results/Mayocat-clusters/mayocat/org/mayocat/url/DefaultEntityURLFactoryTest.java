...
/**
 * @version $Id: f520a0e47d4737d6ecb5bce83fe8b52461078363 $
 *
...
public class DefaultEntityURLFactoryTest {
    ...
    @Rule
    public final MockitoComponentMockingRule<EntityURLFactory> componentManager = new MockitoComponentMockingRule(DefaultEntityURLFactory.class, Arrays.asList(ComponentManager.class, URLHelper.class));
