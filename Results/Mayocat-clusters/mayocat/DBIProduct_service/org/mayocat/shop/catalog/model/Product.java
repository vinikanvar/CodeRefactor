...
public class Product implements Entity, HasAddons, HasModel, HasFeaturedImage, Taxable, Localized, HasType, Child {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equal(this.id, other.id) && Objects.equal(this.title, other.title) && Objects.equal(this.slug, other.slug) && Objects.equal(this.onShelf, other.onShelf) && Objects.equal(this.price, other.price) && Objects.equal(this.taxes, other.taxes) && Objects.equal(this.stock, other.stock) && Objects.equal(this.weight, other.weight) && Objects.equal(this.featuredImageId, other.featuredImageId);
    }
