...
public class Feature implements Entity, HasAddons, Localized, Child {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equal(this.id, other.id) && Objects.equal(this.parentId, other.parentId) && Objects.equal(this.title, other.title) && Objects.equal(this.slug, other.slug) && Objects.equal(this.featureSlug, other.featureSlug) && Objects.equal(this.feature, other.feature);
    }
