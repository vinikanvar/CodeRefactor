...
@Controller
@RequestMapping("/ms3/pingservlet2mdbqueue/")
public class PingServlet2MDBQueueWrapper {

    @RequestMapping(method = RequestMethod.POST, value = "pingservlet2mdbqueue_dopost")
    public @ResponseBody ResponseEntity<Void> doPost(@RequestParam int callerId, @RequestParam int reqId, @RequestParam int resId) {
        try {
            PingServlet2MDBQueueServer callerObj = (PingServlet2MDBQueueServer) idObjMap.get(callerId);
    ...
    @RequestMapping(method = RequestMethod.GET, value = "pingservlet2mdbqueue_doget")
    ...
    @RequestMapping(method = RequestMethod.POST, value = "pingservlet2mdbqueue_init")
    ...
    @RequestMapping(method = RequestMethod.POST, value = "pingservlet2mdbqueue")
