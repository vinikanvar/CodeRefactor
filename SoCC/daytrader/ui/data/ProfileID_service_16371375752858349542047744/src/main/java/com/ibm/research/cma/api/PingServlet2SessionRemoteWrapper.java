...
@Controller
@RequestMapping("/ms1/pingservlet2sessionremote/")
public class PingServlet2SessionRemoteWrapper {

    @RequestMapping(method = RequestMethod.POST, value = "pingservlet2sessionremote_dopost")
    public @ResponseBody ResponseEntity<Void> doPost(@RequestParam int callerId, @RequestParam int reqId, @RequestParam int resId) {
        try {
            PingServlet2SessionRemoteServer callerObj = (PingServlet2SessionRemoteServer) idObjMap.get(callerId);
    ...
    @RequestMapping(method = RequestMethod.GET, value = "pingservlet2sessionremote_doget")
    ...
    @RequestMapping(method = RequestMethod.POST, value = "pingservlet2sessionremote_init")
    ...
    @RequestMapping(method = RequestMethod.POST, value = "pingservlet2sessionremote")
