...
import org.mayocat.shop.marketplace.*;
...
@Component("product")
@Controller
@RequestMapping("/ms2/marketplaceproductentityloader/")
public class MarketplaceProductEntityLoaderWrapper {
    ...
    @RequestMapping(method = RequestMethod.POST, value = "marketplaceproductentityloader")
