...
import org.mayocat.search.elasticsearch.*;
...
@Singleton
@Controller
@RequestMapping("/ms2/elasticsearchsearchengine/")
public class ElasticSearchSearchEngineWrapper {
    ...
    @RequestMapping(method = RequestMethod.POST, value = "elasticsearchsearchengine")
