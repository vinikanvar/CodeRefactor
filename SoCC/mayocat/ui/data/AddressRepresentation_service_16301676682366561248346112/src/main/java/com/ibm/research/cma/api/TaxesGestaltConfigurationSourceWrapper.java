...
import org.mayocat.shop.taxes.configuration.*;
...
@Component("taxes")
@Controller
@RequestMapping("/ms2/taxesgestaltconfigurationsource/")
public class TaxesGestaltConfigurationSourceWrapper {
    ...
    @RequestMapping(method = RequestMethod.POST, value = "taxesgestaltconfigurationsource")
