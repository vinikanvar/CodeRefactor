 ...
 */
public class RegularCheckoutExceptionServer extends CheckoutException {

    public RegularCheckoutExceptionServer() {
    }

    public RegularCheckoutExceptionServer(String message) {
        super(message);
    }

    public RegularCheckoutExceptionServer(String message, Throwable cause) {
        super(message, cause);
    }

    public RegularCheckoutExceptionServer(Throwable cause) {
        super(cause);
    }
}
