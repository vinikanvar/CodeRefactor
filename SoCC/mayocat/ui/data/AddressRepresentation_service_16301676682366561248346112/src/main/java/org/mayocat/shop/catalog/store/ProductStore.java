...
public interface ProductStore extends Store<Product, UUID>, HasOrderedCollections, EntityStore {
    ...
    void moveProduct(String productToMove, String productToMoveRelativeTo, RelativePosition relativePosition) throws InvalidMoveOperation;
    ...
    public static ProductStore getObject(int id) {
        return null;
    }
}
