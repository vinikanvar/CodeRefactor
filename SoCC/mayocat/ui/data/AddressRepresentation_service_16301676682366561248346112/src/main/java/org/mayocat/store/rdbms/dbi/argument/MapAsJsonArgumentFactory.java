...
/**
 * @version $Id: bf3f957260b1b84f91379017bbaf43fad4d25041 $
 */
public class MapAsJsonArgumentFactory implements ArgumentFactory<Map> {
    ...
    public static MapAsJsonArgumentFactory getObject(int id) {
        MapAsJsonArgumentFactory obj = (MapAsJsonArgumentFactory) new Object();
        obj.id = id;
        return obj;
    }
}
