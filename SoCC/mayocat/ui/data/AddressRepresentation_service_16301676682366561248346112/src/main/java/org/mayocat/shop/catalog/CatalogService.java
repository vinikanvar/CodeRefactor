 ...
 *
 * @version $Id: 17b9e0d4e590e3857bdc852c61e0b470a6edaa45 $
 */
@Role
public interface CatalogService {
     ...
     */
    void moveProduct(String slugOfProductToMove, String slugOfProductToMoveBeforeOf) throws InvalidMoveOperation;
     ...
     */
    void moveProduct(String slugOfProductToMove, String slugOfProductToMoveBeforeOf, InsertPosition position) throws InvalidMoveOperation;
     ...
     *      Inserts the product before the relative target.
     */
    void moveCollection(String slugOfCollectionToMove, String slugOfCollectionToMoveBeforeOf) throws InvalidMoveOperation;
     ...
     * @throws InvalidMoveOperation when no sense can be made of move parameters
     */
    void moveCollection(String slugOfCollectionToMove, String slugOfCollectionToMoveBeforeOf, InsertPosition position) throws InvalidMoveOperation;
     ...
     *      Inserts the product before the relative target.
     */
    void moveProductInCollection(Collection collection, String slugOfProductToMove, String slugOfProductToMoveBeforeOf) throws InvalidMoveOperation;
     ...
     * @throws InvalidMoveOperation when no sense can be made of move parameters
     */
    void moveProductInCollection(Collection collection, String slugOfProductToMove, String relativeSlug, InsertPosition position) throws InvalidMoveOperation;
    ...
    public static CatalogService getObject(int id) {
        return null;
    }
}
