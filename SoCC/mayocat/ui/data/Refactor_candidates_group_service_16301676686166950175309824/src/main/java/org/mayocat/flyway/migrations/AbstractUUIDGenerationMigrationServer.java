 ...
 */
public abstract class AbstractUUIDGenerationMigrationServer implements JdbcMigration {
    ...
    public void migrate(Connection connection) throws Exception {
        for (String tableName : getTableNames()) {
            ...
            PreparedStatement statement = connection.prepareStatement("UPDATE " + tableName + getTransitionTableSuffix() + " SET " + getUUIDField() + "=? WHERE " + getIdField() + "=?");
            for (Long id : ids) {
