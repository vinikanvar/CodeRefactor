 ...
 */
public class FlashScopeCookieContainerFilterServer extends AbstractScopeCookieContainerFilter<Flash> implements ContainerResponseFilter, ContainerRequestFilter {
    ...
    protected boolean scopeExistsAndNotEmpty(WebContext context) {
        return context != null && context.getFlash() != null && !context.getFlash().isEmpty() && !context.getFlash().isConsumed();
    }
