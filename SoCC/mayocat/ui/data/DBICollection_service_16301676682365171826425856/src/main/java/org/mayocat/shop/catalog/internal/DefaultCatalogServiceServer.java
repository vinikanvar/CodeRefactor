...
public class DefaultCatalogServiceServer implements CatalogService {
    ...
    public void moveProduct(String slugOfProductToMove, String slugOfProductToRelativeTo, InsertPosition position) throws InvalidMoveOperation {
        this.productStore.get().moveProduct(slugOfProductToMove, slugOfProductToRelativeTo, position.equals(InsertPosition.AFTER) ? HasOrderedCollections.RelativePosition.AFTER : HasOrderedCollections.RelativePosition.BEFORE);
    }
    ...
    public void moveCollection(String slugOfCollectionToMove, String slugOfCollectionToMoveRelativeTo, InsertPosition position) throws InvalidMoveOperation {
        this.collectionStore.get().moveCollection(slugOfCollectionToMove, slugOfCollectionToMoveRelativeTo, position.equals(InsertPosition.AFTER) ? HasOrderedCollections.RelativePosition.AFTER : HasOrderedCollections.RelativePosition.BEFORE);
    }
    ...
    public void moveProductInCollection(Collection collection, String slugOfProductToMove, String relativeSlug, InsertPosition insertPosition) throws InvalidMoveOperation {
        this.collectionStore.get().moveProductInCollection(collection, slugOfProductToMove, relativeSlug, insertPosition.equals(InsertPosition.AFTER) ? HasOrderedCollections.RelativePosition.AFTER : HasOrderedCollections.RelativePosition.BEFORE);
    }
}
