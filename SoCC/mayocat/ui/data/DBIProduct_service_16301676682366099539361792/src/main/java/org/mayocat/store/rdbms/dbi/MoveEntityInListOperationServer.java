        ...
        for (E entity : this.entities) {
            ...
            if (toSlug.equals(entity.getSlug())) {
                if (from == -1) {
                    ...
                    to = relativePosition.equals(HasOrderedCollections.RelativePosition.AFTER) ? i + 1 : i;
                } else {
                    // From is already found : this position or up the list
                    to = relativePosition.equals(HasOrderedCollections.RelativePosition.AFTER) ? i : i - 1;
                }
            }
            i++;
        }
