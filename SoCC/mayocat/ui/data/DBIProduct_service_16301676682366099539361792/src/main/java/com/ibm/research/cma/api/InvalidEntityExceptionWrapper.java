...
public class InvalidEntityExceptionWrapper {
    ...
    @RequestMapping(method = RequestMethod.POST, value = "invalidentityexception")
    ...
    public  @ResponseBody int InvalidEntityException(@RequestParam String message, @RequestParam int errorsId) {
        InvalidEntityExceptionServer newServerObj = new InvalidEntityExceptionServer(message, (Iterable<String>) new Object());
        idObjMap.put(++maxId, newServerObj);
        return maxId;
    }
}
