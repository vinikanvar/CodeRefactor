...
public class GatewayTenantDataWrapper {
    ...
    @RequestMapping(method = RequestMethod.POST, value = "gatewaytenantdata")
    public  @ResponseBody int GatewayTenantData(@RequestParam int tenantIdId, @RequestParam String gateway, @RequestParam int dataId) {
        GatewayTenantDataServer newServerObj = new GatewayTenantDataServer(UUID.getObject(tenantIdId), gateway, (Map<String, Object>) new Object());
