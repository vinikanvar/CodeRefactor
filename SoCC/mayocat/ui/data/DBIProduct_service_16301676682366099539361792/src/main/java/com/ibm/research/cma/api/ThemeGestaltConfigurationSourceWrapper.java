...
import org.mayocat.configuration.theme.*;
...
@Controller
@RequestMapping("/ms1/themegestaltconfigurationsource/")
public class ThemeGestaltConfigurationSourceWrapper {
    ...
    @RequestMapping(method = RequestMethod.POST, value = "themegestaltconfigurationsource")
