...
@Component
@Controller
@RequestMapping("/ms1/jersey920workaroundservletfilter/")
public class JERSEY920WorkaroundServletFilterWrapper {
    ...
    @RequestMapping(method = RequestMethod.POST, value = "jersey920workaroundservletfilter")
