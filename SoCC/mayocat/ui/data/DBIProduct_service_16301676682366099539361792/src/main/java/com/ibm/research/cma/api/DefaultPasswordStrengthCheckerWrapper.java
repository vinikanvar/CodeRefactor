...
import org.mayocat.accounts.passwords.*;
...
@Component
@Controller
@RequestMapping("/ms1/defaultpasswordstrengthchecker/")
public class DefaultPasswordStrengthCheckerWrapper {
    ...
    @RequestMapping(method = RequestMethod.POST, value = "defaultpasswordstrengthchecker")
