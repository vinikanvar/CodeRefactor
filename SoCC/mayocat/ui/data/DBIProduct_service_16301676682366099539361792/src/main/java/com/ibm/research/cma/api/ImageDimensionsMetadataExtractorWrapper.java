...
@Controller
@RequestMapping("/ms1/imagedimensionsmetadataextractor/")
public class ImageDimensionsMetadataExtractorWrapper {
    ...
    @RequestMapping(method = RequestMethod.POST, value = "imagedimensionsmetadataextractor")
