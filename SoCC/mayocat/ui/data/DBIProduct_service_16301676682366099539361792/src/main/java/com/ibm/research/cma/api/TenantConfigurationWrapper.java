...
import org.mayocat.accounts.model.*;
...
public class TenantConfigurationWrapper {
    ...
    @RequestMapping(method = RequestMethod.POST, value = "tenantconfiguration")
    ...
    public  @ResponseBody int TenantConfiguration(@RequestParam final Integer version, @RequestParam final int dataId) {
        TenantConfigurationServer newServerObj = new TenantConfigurationServer(version, (Map<String, Serializable>) new Object());
        idObjMap.put(++maxId, newServerObj);
        return maxId;
    }
    // /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
