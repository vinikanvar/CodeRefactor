 ...
 */
public class V0075_0003__update_tenant_configurationsServer implements JdbcMigration {
    ...
    public void migrate(Connection connection) throws Exception {
        ...
        ResultSet tenants = queryIdsStatement.executeQuery("SELECT entity_id, slug, configuration FROM entity " + "INNER JOIN tenant ON entity.id = tenant.entity_id");
        ...
        PreparedStatement statement = connection.prepareStatement("UPDATE tenant SET name=?, configuration=? WHERE entity_id =?");
