...
@Component("webhooks")
@Controller
@RequestMapping("/ms5/webhooksgestaltconfigurationsource/")
public class WebhooksGestaltConfigurationSourceWrapper {
    ...
    @RequestMapping(method = RequestMethod.POST, value = "webhooksgestaltconfigurationsource")
