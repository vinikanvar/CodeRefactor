...
import org.mayocat.shop.payment.model.*;
...
public class GatewayCustomerDataWrapper {
    ...
    @RequestMapping(method = RequestMethod.POST, value = "gatewaycustomerdata")
    public  @ResponseBody int GatewayCustomerData(@RequestParam int customerIdId, @RequestParam String gateway, @RequestParam int dataId) {
        GatewayCustomerDataServer newServerObj = new GatewayCustomerDataServer(UUID.getObject(customerIdId), gateway, (Map<String, Object>) new Object());
