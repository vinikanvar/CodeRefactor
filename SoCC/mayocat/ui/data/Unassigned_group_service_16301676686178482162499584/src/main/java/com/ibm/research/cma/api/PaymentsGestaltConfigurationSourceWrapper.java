...
import org.mayocat.shop.payment.internal.*;
...
@Component("payments")
@Controller
@RequestMapping("/ms5/paymentsgestaltconfigurationsource/")
public class PaymentsGestaltConfigurationSourceWrapper {
    ...
    @RequestMapping(method = RequestMethod.POST, value = "paymentsgestaltconfigurationsource")
