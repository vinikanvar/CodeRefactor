 ...
 */
public class EntityExtractorServer<E> {
    ...
    public E extract(Map<String, Object> entityData, Class<?> type) {
        ...
        try {
            ...
            for (Method method : entity.getClass().getMethods()) {
                if (method.getName().startsWith("set") && !method.getName().equals("setTranslations") && Character.isUpperCase(method.getName().charAt(3))) {
                    // Found a setter.
