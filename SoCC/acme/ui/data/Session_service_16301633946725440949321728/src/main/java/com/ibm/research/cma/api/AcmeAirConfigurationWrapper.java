...
@Path("/config")
@Controller
@RequestMapping("/ms3/acmeairconfiguration/")
public class AcmeAirConfigurationWrapper {
    ...
    public @ResponseBody Integer getActiveDataServiceInfo(@RequestParam int callerId) {
        AcmeAirConfigurationServer callerObj = (AcmeAirConfigurationServer) idObjMap.get(callerId);
    ...
    @Path("/countBookings")
    @Produces("application/json")
    @RequestMapping(method = RequestMethod.POST, value = "countbookings")
    ...
    @Path("/countCustomers")
    @Produces("application/json")
    @RequestMapping(method = RequestMethod.POST, value = "countcustomer")
    ...
    @Path("/countSessions")
    @Produces("application/json")
    @RequestMapping(method = RequestMethod.POST, value = "countcustomersessions")
    ...
    @Path("/countFlights")
    @Produces("application/json")
    @RequestMapping(method = RequestMethod.POST, value = "countflights")
    ...
    @Produces("application/json")
    @RequestMapping(method = RequestMethod.POST, value = "countflightsegments")
    ...
    @Path("/countAirports")
    @Produces("application/json")
    @RequestMapping(method = RequestMethod.POST, value = "countairports")
    ...
    @RequestMapping(method = RequestMethod.POST, value = "acmeairconfiguration")
