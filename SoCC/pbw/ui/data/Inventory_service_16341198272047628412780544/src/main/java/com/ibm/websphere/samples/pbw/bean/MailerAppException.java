...
public class MailerAppException extends Exception {
    ...
    public MailerAppException() {
        String uri = MicroserviceApplication.projectUri + "/ms0/mailerappexception/mailerappexception_callerId=" + this.id + "";
        int resultTemp = new RestTemplate().getForObject(uri, int.class);
        this.id = resultTemp;
    }

    public MailerAppException(String str) {
        String uri = MicroserviceApplication.projectUri + "/ms0/mailerappexception/mailerappexception?callerId=" + this.id + "&str=str";
        int resultTemp = new RestTemplate().getForObject(uri, int.class);
        this.id = resultTemp;
    }
