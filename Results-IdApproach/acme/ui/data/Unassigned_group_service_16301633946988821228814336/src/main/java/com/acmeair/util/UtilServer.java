        ...
        if (space_id != null) {
            ...
            while (true) {
                try {
                    ...
                    br.close();
                    System.out.println("Response Code : " + conn.getResponseCode() + " Response : " + response.toString());
    ...
    public static String getServiceProxy() {
        ...
        while (true) {
            try {
                ...
                br.close();
                System.out.println("SP Response Code : " + conn.getResponseCode() + " SP Response : " + response.toString());
                JSONParser parser = new JSONParser();
                JSONObject responseJson = (JSONObject) parser.parse(response.toString());
