 ...
 */
public class PaymentRequestServer {
    ...
    public PaymentRequestServer(PaymentStatus status, RequiredAction nextAction) {
        this(status, nextAction, ImmutableMap.<String, Object>of(), Optional.<String>absent());
    }

    public PaymentRequestServer(PaymentStatus status, RequiredAction nextAction, ImmutableMap<String, Object> data) {
        this(status, nextAction, data, Optional.<String>absent());
    }

    public PaymentRequestServer(PaymentStatus status, RequiredAction nextAction, ImmutableMap<String, Object> data, Optional<String> redirectionTarget) {
