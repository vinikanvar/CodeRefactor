...
public class CartWrapper {
    ...
    public  @ResponseBody int Cart(@RequestParam int currencyId, @RequestParam int itemsId, @RequestParam int itemsTotalId, @RequestParam int selectedShippingOptionId, @RequestParam int shippingId) {
        CartServer newServerObj = new CartServer(Currency.getObject(currencyId), (List<CartItem>) new Object(), PriceWithTaxes.getObject(itemsTotalId), (Optional<ShippingOption>) new Object(), (Optional<PriceWithTaxes>) new Object());
