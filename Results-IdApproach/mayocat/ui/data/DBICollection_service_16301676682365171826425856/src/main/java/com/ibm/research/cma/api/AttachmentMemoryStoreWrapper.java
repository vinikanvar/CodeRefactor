...
import org.mayocat.attachment.store.memory.*;
...
@Component("memory")
@Controller
@RequestMapping("/ms0/attachmentmemorystore/")
public class AttachmentMemoryStoreWrapper {
    ...
    @RequestMapping(method = RequestMethod.POST, value = "attachmentmemorystore")
