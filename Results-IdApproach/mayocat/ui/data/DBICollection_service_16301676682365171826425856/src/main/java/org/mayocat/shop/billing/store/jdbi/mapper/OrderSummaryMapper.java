...
/**
 * @version $Id: ed2030c4e82d995c6ce05d12bc82a253c68848cf $
 */
public class OrderSummaryMapper extends AbstractOrderMapper implements ResultSetMapper<OrderSummary> {
    ...
    public static OrderSummaryMapper getObject(int id) {
        OrderSummaryMapper obj = (OrderSummaryMapper) new Object();
        obj.id = id;
        return obj;
    }
}
