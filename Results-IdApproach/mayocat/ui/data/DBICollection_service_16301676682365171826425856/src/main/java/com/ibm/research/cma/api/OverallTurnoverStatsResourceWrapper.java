...
import org.mayocat.shop.billing.api.resource.*;
...
@Controller
@RequestMapping("/ms0/overallturnoverstatsresource/")
public class OverallTurnoverStatsResourceWrapper {
    ...
    @RequestMapping(method = RequestMethod.POST, value = "overallturnoverstatsresource")
