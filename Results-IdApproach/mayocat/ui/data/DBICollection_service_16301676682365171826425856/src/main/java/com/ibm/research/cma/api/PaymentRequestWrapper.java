...
import org.mayocat.shop.payment.*;
...
public class PaymentRequestWrapper {
    ...
    public  @ResponseBody int PaymentRequest(@RequestParam int statusId, @RequestParam int nextActionId, @RequestParam int dataId) {
        PaymentRequestServer newServerObj = new PaymentRequestServer(PaymentStatus.getObject(statusId), RequiredAction.getObject(nextActionId), (ImmutableMap<String, Object>) new Object());
        idObjMap.put(++maxId, newServerObj);
        return maxId;
    }
    ...
    public  @ResponseBody int PaymentRequest(@RequestParam int statusId, @RequestParam int nextActionId, @RequestParam int dataId, @RequestParam int redirectionTargetId) {
        PaymentRequestServer newServerObj = new PaymentRequestServer(PaymentStatus.getObject(statusId), RequiredAction.getObject(nextActionId), (ImmutableMap<String, Object>) new Object(), (Optional<String>) new Object());
        idObjMap.put(++maxId, newServerObj);
        return maxId;
    }
}
