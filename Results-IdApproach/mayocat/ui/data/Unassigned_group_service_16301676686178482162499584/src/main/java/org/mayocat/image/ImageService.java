...
/**
 * @version $Id: a75dc0ac2ce0a94675088ad8e85ca269675f0d6c $
 */
@Role
public interface ImageService {
     ...
     */
    Optional<Dimension> newDimension(Attachment image, Optional<Integer> width, Optional<Integer> height) throws IOException;

    Optional<Dimension> newDimension(Rectangle boundaries, Optional<Integer> width, Optional<Integer> height) throws IOException;

    public int id = 0;

    public static ImageService getObject(int id) {
        return null;
    }
}
