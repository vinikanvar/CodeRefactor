...
import org.mayocat.internal.meta.*;
...
public class DefaultEntityMetaRegistryWrapper {
    ...
    @RequestMapping(method = RequestMethod.POST, value = "defaultentitymetaregistry")
    public  @ResponseBody int DefaultEntityMetaRegistry(@RequestParam int entitiesId) {
        DefaultEntityMetaRegistryServer newServerObj = new DefaultEntityMetaRegistryServer((List<EntityMeta>) new Object());
