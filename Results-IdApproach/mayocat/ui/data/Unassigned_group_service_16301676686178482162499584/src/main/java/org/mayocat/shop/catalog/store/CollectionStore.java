...
public interface CollectionStore extends Store<Collection, UUID>, EntityStore, HasOrderedCollections {
    ...
    void moveCollection(String collectionToMove, String collectionToMoveRelativeTo, RelativePosition relativePosition) throws InvalidMoveOperation;

    void moveProductInCollection(Collection collection, String productToMove, String productToMoveRelativeTo, RelativePosition relativePosition) throws InvalidMoveOperation;
    ...
    public static CollectionStore getObject(int id) {
        return null;
    }
}
