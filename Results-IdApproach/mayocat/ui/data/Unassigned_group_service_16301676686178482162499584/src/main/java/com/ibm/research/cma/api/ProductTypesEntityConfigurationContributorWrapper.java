...
import org.mayocat.shop.catalog.configuration.*;
...
@Controller
@RequestMapping("/ms5/producttypesentityconfigurationcontributor/")
public class ProductTypesEntityConfigurationContributorWrapper {
    ...
    @RequestMapping(method = RequestMethod.POST, value = "producttypesentityconfigurationcontributor")
