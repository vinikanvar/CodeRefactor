...
public abstract class AbstractGenericEntityMappingGeneratorServer implements EntityMappingGenerator {
    ...
    public Map<String, Object> generateMapping() {
        ...
        try {
            try {
                String fullJson = Resources.toString(Resources.getResource(getMappingFileName(forClass())), Charsets.UTF_8);
                ...
                try {
                    String propertiesJson = Resources.toString(Resources.getResource(getPropertiesMappingFileName(forClass())), Charsets.UTF_8);
