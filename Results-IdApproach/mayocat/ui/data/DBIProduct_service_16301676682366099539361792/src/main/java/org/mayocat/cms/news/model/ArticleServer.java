...
public class ArticleServer implements Entity, HasAddons, HasModel, HasFeaturedImage {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equal(this.id, other.id) && Objects.equal(this.title, other.title) && Objects.equal(this.slug, other.slug) && Objects.equal(this.content, other.content);
    }
