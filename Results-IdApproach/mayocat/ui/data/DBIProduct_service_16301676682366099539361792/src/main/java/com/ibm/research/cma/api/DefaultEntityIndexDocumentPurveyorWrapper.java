...
import org.mayocat.search.elasticsearch.internal.*;
...
@Component
@Controller
@RequestMapping("/ms1/defaultentityindexdocumentpurveyor/")
public class DefaultEntityIndexDocumentPurveyorWrapper {
    ...
    @RequestMapping(method = RequestMethod.POST, value = "defaultentityindexdocumentpurveyor")
