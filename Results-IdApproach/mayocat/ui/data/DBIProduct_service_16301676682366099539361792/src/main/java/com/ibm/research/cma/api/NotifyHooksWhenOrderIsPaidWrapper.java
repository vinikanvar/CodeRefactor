...
import org.mayocat.shop.billing.internal.*;
...
@Controller
@RequestMapping("/ms1/notifyhookswhenorderispaid/")
public class NotifyHooksWhenOrderIsPaidWrapper {
    ...
    @RequestMapping(method = RequestMethod.POST, value = "notifyhookswhenorderispaid")
