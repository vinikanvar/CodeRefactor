...
import org.mayocat.accounts.jersey.*;
...
@Controller
@RequestMapping("/ms1/checktenantandusermethoddispatch/")
public class CheckTenantAndUserMethodDispatchWrapper {
    ...
    @RequestMapping(method = RequestMethod.POST, value = "checktenantandusermethoddispatch")
