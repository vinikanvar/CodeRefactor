...
public class ApplicationStartedEventWrapper {
    ...
    public  @ResponseBody boolean matches(@RequestParam int callerId, @RequestParam int otherEventId) {
        ApplicationStartedEventServer callerObj = (ApplicationStartedEventServer) idObjMap.get(callerId);
    ...
    @RequestMapping(method = RequestMethod.POST, value = "applicationstartedevent")
