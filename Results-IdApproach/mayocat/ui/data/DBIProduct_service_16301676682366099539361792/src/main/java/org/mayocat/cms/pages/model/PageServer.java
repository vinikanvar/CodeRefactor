...
public class PageServer implements Entity, Localized, Child, HasAddons, HasModel, HasFeaturedImage {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equal(this.id, other.id) && Objects.equal(this.parentId, other.parentId) && Objects.equal(this.title, other.title) && Objects.equal(this.slug, other.slug) && Objects.equal(this.content, other.content) && Objects.equal(this.published, other.published) && Objects.equal(this.addons, other.addons);
    }
