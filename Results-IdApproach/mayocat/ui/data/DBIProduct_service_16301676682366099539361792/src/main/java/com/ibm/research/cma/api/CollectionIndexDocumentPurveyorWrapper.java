...
import org.mayocat.shop.catalog.search.*;
...
@Component
@Controller
@RequestMapping("/ms1/collectionindexdocumentpurveyor/")
public class CollectionIndexDocumentPurveyorWrapper {
    ...
    @RequestMapping(method = RequestMethod.POST, value = "collectionindexdocumentpurveyor")
