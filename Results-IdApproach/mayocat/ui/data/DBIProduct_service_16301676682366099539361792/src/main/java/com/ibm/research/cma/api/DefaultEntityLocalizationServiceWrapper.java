...
import org.mayocat.localization.internal.*;
...
@Component
@Controller
@RequestMapping("/ms1/defaultentitylocalizationservice/")
public class DefaultEntityLocalizationServiceWrapper {
    ...
    @RequestMapping(method = RequestMethod.POST, value = "defaultentitylocalizationservice")
