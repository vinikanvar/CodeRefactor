...
import org.mayocat.mail.internal.*;
...
@Component
@Controller
@RequestMapping("/ms1/defaultmailtemplateservice/")
public class DefaultMailTemplateServiceWrapper {
    ...
    @RequestMapping(method = RequestMethod.POST, value = "defaultmailtemplateservice")
