...
import org.mayocat.shop.billing.*;
...
@Controller
@RequestMapping("/ms1/paymentoperationeventlistener/")
public class PaymentOperationEventListenerWrapper {
    ...
    @RequestMapping(method = RequestMethod.POST, value = "paymentoperationeventlistener")
