...
public class FlywayMigrateCommandWrapper<T extends Configuration> {
    ...
    @RequestMapping(method = RequestMethod.POST, value = "flywaymigratecommand")
    public  @ResponseBody int FlywayMigrateCommand(@RequestParam int strategyId, @RequestParam int configurationClassId) {
        FlywayMigrateCommandServer newServerObj = new FlywayMigrateCommandServer((DatabaseConfiguration<T>) new Object(), (Class<T>) new Object());
