...
import org.mayocat.shop.invoicing.internal.*;
...
@Component
@Controller
@RequestMapping("/ms1/defaultinvoicingservice/")
public class DefaultInvoicingServiceWrapper {
    ...
    @RequestMapping(method = RequestMethod.POST, value = "defaultinvoicingservice")
