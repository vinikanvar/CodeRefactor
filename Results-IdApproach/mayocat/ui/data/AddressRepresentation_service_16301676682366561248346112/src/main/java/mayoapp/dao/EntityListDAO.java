 ...
 *
 * @version $Id: 98eee4f4ec704e591dc4cd2bc1c2754916e51547 $
 */
...
public interface EntityListDAO extends EntityDAO<EntityList>, Transactional<EntityListDAO> {
    ...
    @SqlQuery
    List<EntityList> findByHint(@Bind("hint") String hint, @Bind("tenantId") UUID tenant);
    ...
    public static EntityListDAO getObject(int id) {
        return null;
    }
}
