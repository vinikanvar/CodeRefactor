...
import org.mayocat.shop.catalog.configuration.source.*;
...
@Component("catalog")
@Controller
@RequestMapping("/ms2/cataloggestaltconfigurationsource/")
public class CatalogGestaltConfigurationSourceWrapper {
    ...
    @RequestMapping(method = RequestMethod.POST, value = "cataloggestaltconfigurationsource")
