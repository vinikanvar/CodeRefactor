...
import org.mayocat.shop.payment.store.jdbi.*;
...
@Component
@Controller
@RequestMapping("/ms2/dbipaymentoperationstore/")
public class DBIPaymentOperationStoreWrapper {
    ...
    public @ResponseBody ResponseEntity<Integer> create(@RequestParam int callerId, @Valid @RequestParam int operationId) {
        try {
            DBIPaymentOperationStoreServer callerObj = (DBIPaymentOperationStoreServer) idObjMap.get(callerId);
    ...
    @RequestMapping(method = RequestMethod.POST, value = "countall")
    ...
    @RequestMapping(method = RequestMethod.POST, value = "dbipaymentoperationstore")
