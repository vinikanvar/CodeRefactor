...
import org.mayocat.shop.shipping.rest.resource.*;
...
@Controller
@RequestMapping("/ms2/destinationsresource/")
public class DestinationsResourceWrapper {
    ...
    @RequestMapping(method = RequestMethod.POST, value = "destinationsresource")
