...
import org.mayocat.configuration.internal.*;
...
@Component
@Controller
@RequestMapping("/ms2/defaultconfigurationservice/")
public class DefaultConfigurationServiceWrapper {
    ...
    @RequestMapping(method = RequestMethod.POST, value = "defaultconfigurationservice")
