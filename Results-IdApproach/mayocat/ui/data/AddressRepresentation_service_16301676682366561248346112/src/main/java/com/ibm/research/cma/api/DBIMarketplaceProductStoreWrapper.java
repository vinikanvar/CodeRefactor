...
import org.mayocat.shop.marketplace.store.jdbi.*;
...
@Controller
@RequestMapping("/ms2/dbimarketplaceproductstore/")
public class DBIMarketplaceProductStoreWrapper {
    ...
    @RequestMapping(method = RequestMethod.POST, value = "dbimarketplaceproductstore")
