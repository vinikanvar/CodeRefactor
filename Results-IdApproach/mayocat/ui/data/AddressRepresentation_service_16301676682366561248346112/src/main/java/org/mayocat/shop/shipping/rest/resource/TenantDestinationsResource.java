 ...
 *
 * @version $Id: 3f5d11052278c920c5d3ad1b266fde7c3db1d92e $
 */
...
public class TenantDestinationsResource extends DestinationsResource {
    ...
    public static TenantDestinationsResource getObject(int id) {
        TenantDestinationsResource obj = (TenantDestinationsResource) new Object();
        obj.id = id;
        return obj;
    }
}
