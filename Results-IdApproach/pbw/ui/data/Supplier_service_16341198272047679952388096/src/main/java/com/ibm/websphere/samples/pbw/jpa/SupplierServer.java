...
public class SupplierServer {
    ...
    public SupplierServer(String supplierID) {
     ...
     * @param url
     */
    public SupplierServer(String supplierID, String name, String street, String city, String state, String zip, String phone, String url) {
