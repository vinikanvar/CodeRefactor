...
public class DTBroker3MDB implements MessageListener {
    ...
    public DTBroker3MDB() {
        String uri = MicroserviceApplication.projectUri + "/ms1/dtbroker3mdb/dtbroker3mdbcallerId=" + this.id + "";
    ...
    public void onMessage(Message message) {
        String uri = MicroserviceApplication.projectUri + "/ms1/dtbroker3mdb/dtbroker3mdb_onmessage?callerId=" + this.id + "&messageId=message.id";
