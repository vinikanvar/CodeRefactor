...
@Controller
@RequestMapping("/ms3/pingservlet2include/")
public class PingServlet2IncludeWrapper {
     ...
     */
    @RequestMapping(method = RequestMethod.POST, value = "pingservlet2include_dopost")
    public @ResponseBody ResponseEntity<Void> doPost(@RequestParam int callerId, @RequestParam int reqId, @RequestParam int resId) {
        try {
            PingServlet2IncludeServer callerObj = (PingServlet2IncludeServer) idObjMap.get(callerId);
     ...
     *            HttpServletResponce
     */
    @RequestMapping(method = RequestMethod.GET, value = "pingservlet2include_doget")
     ...
     *            ServletConfig:
     */
    @RequestMapping(method = RequestMethod.POST, value = "pingservlet2include_init")
    ...
    @RequestMapping(method = RequestMethod.POST, value = "pingservlet2include")
