...
public class DTStreamer3MDB implements MessageListener {
    ...
    public DTStreamer3MDB() {
        String uri = MicroserviceApplication.projectUri + "/ms0/dtstreamer3mdb/dtstreamer3mdbcallerId=" + this.id + "";
    ...
    public void onMessage(Message message) {
        String uri = MicroserviceApplication.projectUri + "/ms0/dtstreamer3mdb/onmessage?callerId=" + this.id + "&messageId=message.id";
