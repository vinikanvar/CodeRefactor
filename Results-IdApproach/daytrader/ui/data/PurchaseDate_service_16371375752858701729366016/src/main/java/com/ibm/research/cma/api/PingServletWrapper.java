...
@Controller
@RequestMapping("/ms4/pingservlet/")
public class PingServletWrapper {
     ...
     */
    @RequestMapping(method = RequestMethod.POST, value = "pingservlet_dopost")
    public @ResponseBody ResponseEntity<Void> doPost(@RequestParam int callerId, @RequestParam int reqId, @RequestParam int resId) {
        try {
            PingServletServer callerObj = (PingServletServer) idObjMap.get(callerId);
     ...
     *            HttpServletResponce
     */
    @RequestMapping(method = RequestMethod.GET, value = "pingservlet_doget")
     ...
     *            ServletConfig:
     */
    @RequestMapping(method = RequestMethod.POST, value = "pingservlet_init")
    ...
    @RequestMapping(method = RequestMethod.POST, value = "pingservlet")
