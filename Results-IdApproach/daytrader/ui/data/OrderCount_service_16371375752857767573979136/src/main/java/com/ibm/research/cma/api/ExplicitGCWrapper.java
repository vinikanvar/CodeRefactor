...
public class ExplicitGCWrapper {
     ...
     */
    @RequestMapping(method = RequestMethod.POST, value = "explicitgc_dopost")
    public @ResponseBody ResponseEntity<Void> doPost(@RequestParam int callerId, @RequestParam int reqId, @RequestParam int resId) {
        try {
            ExplicitGCServer callerObj = (ExplicitGCServer) idObjMap.get(callerId);
     ...
     *            HttpServletResponce
     */
    @RequestMapping(method = RequestMethod.GET, value = "explicitgc_doget")
     ...
     *            ServletConfig:
     */
    @RequestMapping(method = RequestMethod.POST, value = "explicitgc_init")
    ...
    @RequestMapping(method = RequestMethod.POST, value = "explicitgc")
