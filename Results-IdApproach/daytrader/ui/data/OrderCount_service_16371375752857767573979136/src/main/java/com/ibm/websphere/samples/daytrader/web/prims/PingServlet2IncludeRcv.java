...
public class PingServlet2IncludeRcv extends HttpServlet {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) {
        String uri = MicroserviceApplication.projectUri + "/msnull/pingservlet2includercv/pingservlet2includercv_dopost?callerId=" + this.id + "&reqId=req.id&resId=res.id";
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) {
        String uri = MicroserviceApplication.projectUri + "/msnull/pingservlet2includercv/pingservlet2includercv_doget?callerId=" + this.id + "&reqId=req.id&resId=res.id";
        ResponseEntity<Void> resultTemp = new RestTemplate().getForEntity(uri, void.class);
    }

    public int id = 0;

    public static PingServlet2IncludeRcv getObject(int id) {
        PingServlet2IncludeRcv obj = (PingServlet2IncludeRcv) new Object();
        obj.id = id;
        return obj;
    }
}
