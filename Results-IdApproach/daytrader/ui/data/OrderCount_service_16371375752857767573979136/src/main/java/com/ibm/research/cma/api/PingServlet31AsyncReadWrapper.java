...
@Controller
@RequestMapping("/ms0/pingservlet31asyncread/")
public class PingServlet31AsyncReadWrapper {
     ...
     */
    @RequestMapping(method = RequestMethod.POST, value = "pingservlet31asyncread_dopost")
    public @ResponseBody ResponseEntity<Void> doPost(@RequestParam int callerId, @RequestParam int reqId, @RequestParam int resId) {
        try {
            PingServlet31AsyncReadServer callerObj = (PingServlet31AsyncReadServer) idObjMap.get(callerId);
     ...
     *            HttpServletResponce
     */
    @RequestMapping(method = RequestMethod.GET, value = "pingservlet31asyncread_doget")
     ...
     *            ServletConfig:
     */
    @RequestMapping(method = RequestMethod.POST, value = "pingservlet31asyncread_init")
    ...
    @RequestMapping(method = RequestMethod.POST, value = "pingservlet31asyncread")
