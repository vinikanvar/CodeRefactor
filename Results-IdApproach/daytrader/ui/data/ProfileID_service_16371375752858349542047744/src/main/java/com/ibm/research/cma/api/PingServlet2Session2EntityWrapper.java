...
@Controller
@RequestMapping("/ms1/pingservlet2session2entity/")
public class PingServlet2Session2EntityWrapper {

    @RequestMapping(method = RequestMethod.POST, value = "pingservlet2session2entity_dopost")
    public @ResponseBody ResponseEntity<Void> doPost(@RequestParam int callerId, @RequestParam int reqId, @RequestParam int resId) {
        try {
            PingServlet2Session2EntityServer callerObj = (PingServlet2Session2EntityServer) idObjMap.get(callerId);
    ...
    @RequestMapping(method = RequestMethod.GET, value = "pingservlet2session2entity_doget")
    ...
    @RequestMapping(method = RequestMethod.POST, value = "pingservlet2session2entity_init")
    ...
    @RequestMapping(method = RequestMethod.POST, value = "pingservlet2session2entity")
