...
@Controller
@RequestMapping("/ms1/pingservlet2db/")
public class PingServlet2DBWrapper {
     ...
     */
    @RequestMapping(method = RequestMethod.POST, value = "pingservlet2db_dopost")
    public @ResponseBody ResponseEntity<Void> doPost(@RequestParam int callerId, @RequestParam int reqId, @RequestParam int resId) {
        try {
            PingServlet2DBServer callerObj = (PingServlet2DBServer) idObjMap.get(callerId);
     ...
     *            HttpServletResponce
     */
    @RequestMapping(method = RequestMethod.GET, value = "pingservlet2db_doget")
     ...
     *            ServletConfig:
     */
    @RequestMapping(method = RequestMethod.POST, value = "pingservlet2db_init")
    ...
    @RequestMapping(method = RequestMethod.POST, value = "pingservlet2db")
