...
@Controller
@RequestMapping("/ms1/pingjdbcread2jsp/")
public class PingJDBCRead2JSPWrapper {
     ...
     */
    @RequestMapping(method = RequestMethod.POST, value = "pingjdbcread2jsp_dopost")
    public @ResponseBody ResponseEntity<Void> doPost(@RequestParam int callerId, @RequestParam int reqId, @RequestParam int resId) {
        try {
            PingJDBCRead2JSPServer callerObj = (PingJDBCRead2JSPServer) idObjMap.get(callerId);
     ...
     *            HttpServletResponce
     */
    @RequestMapping(method = RequestMethod.GET, value = "pingjdbcread2jsp_doget")
     ...
     *            ServletConfig:
     */
    @RequestMapping(method = RequestMethod.POST, value = "pingjdbcread2jsp_init")
    ...
    @RequestMapping(method = RequestMethod.POST, value = "pingjdbcread2jsp")
