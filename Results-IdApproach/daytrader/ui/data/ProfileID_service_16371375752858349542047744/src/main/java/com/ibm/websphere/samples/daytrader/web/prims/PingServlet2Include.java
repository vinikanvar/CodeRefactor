...
public class PingServlet2Include extends HttpServlet {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) {
        String uri = MicroserviceApplication.projectUri + "/ms3/pingservlet2include/pingservlet2include_dopost?callerId=" + this.id + "&reqId=req.id&resId=res.id";
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) {
        String uri = MicroserviceApplication.projectUri + "/ms3/pingservlet2include/pingservlet2include_doget?callerId=" + this.id + "&reqId=req.id&resId=res.id";
        ResponseEntity<Void> resultTemp = new RestTemplate().getForEntity(uri, void.class);
    }
    ...
    public void init(ServletConfig config) {
        String uri = MicroserviceApplication.projectUri + "/ms3/pingservlet2include/pingservlet2include_init?callerId=" + this.id + "&configId=config.id";
        ResponseEntity<Void> resultTemp = new RestTemplate().getForEntity(uri, void.class);
    }
