...
@Controller
@RequestMapping("/ms1/pingservlet2session2cmrone2many/")
public class PingServlet2Session2CMROne2ManyWrapper {

    @RequestMapping(method = RequestMethod.POST, value = "pingservlet2session2cmrone2many_dopost")
    public @ResponseBody ResponseEntity<Void> doPost(@RequestParam int callerId, @RequestParam int reqId, @RequestParam int resId) {
        try {
            PingServlet2Session2CMROne2ManyServer callerObj = (PingServlet2Session2CMROne2ManyServer) idObjMap.get(callerId);
    ...
    @RequestMapping(method = RequestMethod.GET, value = "pingservlet2session2cmrone2many_doget")
    ...
    @RequestMapping(method = RequestMethod.POST, value = "pingservlet2session2cmrone2many_init")
    ...
    @RequestMapping(method = RequestMethod.POST, value = "pingservlet2session2cmrone2many")
