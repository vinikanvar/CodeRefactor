...
public class PingSession3 extends HttpServlet {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) {
        String uri = MicroserviceApplication.projectUri + "/ms0/pingsession3/pingsession3_dopost?callerId=" + this.id + "&reqId=req.id&resId=res.id";
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) {
        String uri = MicroserviceApplication.projectUri + "/ms0/pingsession3/pingsession3_doget?callerId=" + this.id + "&requestId=request.id&responseId=response.id";
        ResponseEntity<Void> resultTemp = new RestTemplate().getForEntity(uri, void.class);
    }
    ...
    public void init(ServletConfig config) {
        String uri = MicroserviceApplication.projectUri + "/ms0/pingsession3/pingsession3_init?callerId=" + this.id + "&configId=config.id";
        ResponseEntity<Void> resultTemp = new RestTemplate().getForEntity(uri, void.class);
    }
