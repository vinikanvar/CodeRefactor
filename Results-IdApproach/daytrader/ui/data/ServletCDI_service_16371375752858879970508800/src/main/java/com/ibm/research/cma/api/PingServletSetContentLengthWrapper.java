...
@Controller
@RequestMapping("/ms5/pingservletsetcontentlength/")
public class PingServletSetContentLengthWrapper {
     ...
     */
    @RequestMapping(method = RequestMethod.POST, value = "pingservletsetcontentlength_dopost")
    public @ResponseBody ResponseEntity<Void> doPost(@RequestParam int callerId, @RequestParam int reqId, @RequestParam int resId) {
        try {
            PingServletSetContentLengthServer callerObj = (PingServletSetContentLengthServer) idObjMap.get(callerId);
     ...
     *            HttpServletResponce
     */
    @RequestMapping(method = RequestMethod.GET, value = "pingservletsetcontentlength_doget")
     ...
     *            ServletConfig:
     */
    @RequestMapping(method = RequestMethod.POST, value = "pingservletsetcontentlength_init")
    ...
    @RequestMapping(method = RequestMethod.POST, value = "pingservletsetcontentlength")
