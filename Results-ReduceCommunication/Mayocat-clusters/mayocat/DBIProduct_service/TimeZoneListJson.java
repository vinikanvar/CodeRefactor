...
public class TimeZoneListJson {
    ...
    static final DateTimeFormatter cOffsetFormatter = new DateTimeFormatterBuilder().appendTimeZoneOffset(null, true, 2, 4).toFormatter();
    ...
    public static void main(String[] args) throws Exception {
        ...
        LinkedHashMap<String, ArrayList<ZoneData>> zones = new LinkedHashMap<String, ArrayList<ZoneData>>();
        {
            ...
            while (it.hasNext()) {
                ...
                if (id.matches("^[A-Za-z_-]+?/[A-Za-z_-]+?(/[A-Za-z_-]+?)?") && !id.matches("^Etc/[A-Za-z0-9_-]+?")) {
                    String k = id.split("/")[0];
