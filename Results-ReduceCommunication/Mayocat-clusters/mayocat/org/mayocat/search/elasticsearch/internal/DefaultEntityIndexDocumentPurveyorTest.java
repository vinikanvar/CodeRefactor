...
/**
 * @version $Id: c7415965f7c79a7854febd34dfe7d224d6630c25 $
 */
@ComponentList({ EntityIndexDocumentPurveyor.class, ComponentManager.class, CustomEntityIndexDocumentPurveyor.class, DefaultEntityURLFactory.class, DefaultURLHelper.class })
public class DefaultEntityIndexDocumentPurveyorTest {
    ...
    @Rule
    public final MockitoComponentMockingRule<EntityIndexDocumentPurveyor> componentManager = new MockitoComponentMockingRule(DefaultEntityIndexDocumentPurveyor.class, Arrays.asList(ComponentManager.class, URLHelper.class, EntityURLFactory.class));

    @Test
    public void testGetDocumentFromEntityThatHasAClassLevelIndexAnnotation() throws ComponentLookupException {
        EntityWithClassLevelIndexAnnotation entity = new EntityWithClassLevelIndexAnnotation(UUID.randomUUID(), "my-test-entity");
    ...
    public void testGetDocumentFromEntityThatHasFieldLevelIndexAnnotation() throws ComponentLookupException {
        EntityWithFieldLevelIndexAnnotations entity = new EntityWithFieldLevelIndexAnnotations(UUID.randomUUID(), "my-test-entity");
        entity.setMyIndexedField("this is indexed");
        entity.setMyNotIndexField("this is NOT indexed");
        Map<String, Object> source = this.componentManager.getComponentUnderTest().purveyDocument(entity, tenant);
        Assert.assertEquals("this is indexed", ((Map<String, Object>) source.get("properties")).get("myIndexedField"));
    ...
    public void testGetDocumentFromEntityWithFeaturedImage() throws ComponentLookupException {
        final AttachmentStore attachmentStore = this.componentManager.getInstance(AttachmentStore.class);
