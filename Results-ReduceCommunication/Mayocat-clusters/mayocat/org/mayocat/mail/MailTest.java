 ...
 * Test for {@link Mail}
 *
 * @version $Id: 0ff6d92d36b0a0bf6011853a7779d2aa4dedef57 $
 */
public class MailTest {

    @Test
    public void testEmailCreation() {
        Mail mail = new Mail().from("admin@org").to("user@org").cc("manager@org", "boss@org").bcc("friend@org").subject("A propos").text("Bluk");
