 ...
 * path, the url,
 *
 * @version $Id: 208e750fa13c3d3ed6155d395880677b343e07c0 $
 */
...
public class LocalesInfoWebDataSupplier implements WebDataSupplier {
    ...
    public void supply(Map<String, Object> data) {
        ...
        List<Locale> alternativeLocales = FluentIterable.from(settings.getLocales().getOtherLocales().getValue()).filter(Predicates.notNull()).toList();
