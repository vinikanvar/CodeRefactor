 ...
 *
 * @version $Id: 70396dc91eeccd72a2503abacbebefe8ec151b77 $
 */
@Component("site")
public class SiteWebDataSupplier implements WebDataSupplier {
    ...
    public void supply(Map<String, Object> data) {
        ...
        EntityData<Tenant> tenantData = dataLoader.load(tenant, StandardOptions.LOCALIZE, AttachmentLoadingOptions.FEATURED_IMAGE_ONLY);
