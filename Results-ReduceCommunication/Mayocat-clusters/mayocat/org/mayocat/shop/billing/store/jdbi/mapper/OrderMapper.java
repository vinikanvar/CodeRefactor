...
public class OrderMapper extends AbstractOrderMapper implements ResultSetMapper<Order> {
    ...
    public Order map(int index, ResultSet resultSet, StatementContext ctx) throws SQLException {
        ...
        try {
            List<Map<String, Object>> itemsData = mapper.readValue(resultSet.getString("items"), new TypeReference<List<Map<String, Object>>>() {
            });
            List<OrderItem> items = FluentIterable.from(itemsData).transform(new Function<Map<String, Object>, OrderItem>() {
