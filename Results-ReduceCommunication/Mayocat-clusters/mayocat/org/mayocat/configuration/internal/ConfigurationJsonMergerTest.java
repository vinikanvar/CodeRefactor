...
public class ConfigurationJsonMergerTest extends AbstractConfigurationTest {
    ...
    public void setUp() throws Exception {
        ...
        File notConfigurableConfigurationFile = new File(Resources.getResource("configuration/locales-not-configurable.yml").toURI());
    ...
    public void testConfigurationMerge() throws Exception {
        ...
        Assert.assertEquals(Locale.FRANCE.toString(), ((Map<String, Object>) ((Map<String, Object>) merged.get("locales")).get("main")).get("value"));
    }
    ...
    public void testConfigurationMergeWhenPropertyIsNotConfigurable() throws Exception {
        ...
        ConfigurationJsonMerger merger = new ConfigurationJsonMerger(generalConfiguration, tenantConfiguration);
        Map<String, Serializable> merged = merger.merge();
        Assert.assertEquals(Locale.ENGLISH.toString(), ((Map<String, Object>) ((Map<String, Object>) merged.get("locales")).get("main")).get("value"));
    }
    // ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
}
