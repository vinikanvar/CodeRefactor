...
public class AbstractJsonConfigurationHandler {
    ...
    protected boolean isConfigurableEntry(Map<String, Serializable> entry) {
        return entry.containsKey(CONFIGURABLE_KEY) && Boolean.class.isAssignableFrom(entry.get(CONFIGURABLE_KEY).getClass()) && entry.containsKey(DEFAULT_KEY) && entry.containsKey(VISIBLE_KEY);
    }
}
